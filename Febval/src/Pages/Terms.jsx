...
const Terms = () => {
	return (
		<Container className="terms-container" style={{ paddingTop: "150px" }}>
			<div className="terms text-center">
				<h1> TERMS AND CONDITIONS</h1>
			</div>
			<>
				
				<p className="mb-5">Last updated: 2022-11-30</p>
				<p>
					1. <b>Introduction</b>
				</p>
				<p>
					Welcome to <b>Febval's gift</b> (“Company”, “we”, “our”,
					“us”)!
				</p>
				<p>
					These Terms of Service (“Terms”, “Terms of Service”) govern
					your use of our website located at <b>febval.com</b>{" "}
				...
				<p>
					...
					emailing at <b>info@febval.com</b> so we can try to find a
				...
				<p>
					...
					link or by emailing at info@febval.com.
				</p>
				<p>
					3. <b>Purchases</b>
				</p>
				<p>
					...
					including but not limited to, your credit or debit card
					number, the expiration date of your card, your billing
					address, and your shipping information.
				</p>
				<p>
					You represent and warrant that: (i) you have the legal right
					to use any card(s) or other payment method(s) in connection
					with any Purchase; and that (ii) the information you supply
				...
				<p>
					We issue refunds for Contracts within <b>5 days</b> of the
				...
				<p>
					...
					Febval's gift or used with permission. You may not
				...
				<p>
					...
					in any way is illegal, threatening, fraudulent, or harmful,
				...
				<p>
					...
					the exclusive property of Febval's gift and its licensors.
					Service is protected by copyright, trademark, and other laws
					of and foreign countries. Our trademarks may not be used in
					connection with any product or service without the prior
					written consent of Febval's gift.
				</p>
				<p>
				...
				<p>
					...
					please submit your claim via email to info@febval.com, with
				...
				<p>
					You may provide us either directly at info@febval.com or via
				...
				<p>
					...
					services that are not owned or controlled by Febval's gift.
				</p>
				<p>
					Febval's gift has no control over, and assumes no
				...
				<p>
					...
					is an easy-to-use free tool for creating an excellent
					standard Terms of Service template for a website, blog,
				...
				<p>
					...
					with the laws of india, which governing law applies to
				...
				<p className="my-5"> 
					...
					support by email: <b>info@febval.com</b>.
				</p>
